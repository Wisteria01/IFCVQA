# Image Feature Cropping VQA (IFCVQA)

This repository corresponds to the **PyTorch** implementation of the IFCVQA.
Our code is modified based on the MCAN framework. The source code can be download in https://github.com/MILVLG/mcan-vqa. 
...
1. If you wish to test the training results on the VQA-CP V2 dataset, please download it yourself from its official website and also place it in the dataset/vqa directory
2. Please modify your dataset address in path_cfgs.py. The training commands are consistent with the VQA 2.0 dataset
